...
class DialIf {
 public:
  ...
  virtual RetCode::type isPrimary(const bool isPrimary) = 0;
...
typedef struct _Dial_isPrimary_args__isset {
  _Dial_isPrimary_args__isset() : isPrimary(false) {}
  bool isPrimary;
} _Dial_isPrimary_args__isset;

class Dial_isPrimary_args {
 public:

  Dial_isPrimary_args() : isPrimary(0) {
  }

  virtual ~Dial_isPrimary_args() throw() {}

  bool isPrimary;

  _Dial_isPrimary_args__isset __isset;

  void __set_isPrimary(const bool val) {
    isPrimary = val;
  }

  bool operator == (const Dial_isPrimary_args & rhs) const
  {
    if (!(isPrimary == rhs.isPrimary))
      return false;
    return true;
  }
  bool operator != (const Dial_isPrimary_args &rhs) const {
  ...
  bool operator < (const Dial_isPrimary_args & ) const;
...
class Dial_isPrimary_pargs {
 public:


  virtual ~Dial_isPrimary_pargs() throw() {}
...
typedef struct _Dial_isPrimary_result__isset {
  _Dial_isPrimary_result__isset() : success(false), ex(false) {}
  bool success;
  bool ex;
} _Dial_isPrimary_result__isset;

class Dial_isPrimary_result {
 public:

  Dial_isPrimary_result() : success((RetCode::type)0) {
  }

  virtual ~Dial_isPrimary_result() throw() {}

  RetCode::type success;
  Xception ex;

  _Dial_isPrimary_result__isset __isset;
  ...
  bool operator == (const Dial_isPrimary_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ex == rhs.ex))
  ...
  bool operator < (const Dial_isPrimary_result & ) const;
...
typedef struct _Dial_isPrimary_presult__isset {
  _Dial_isPrimary_presult__isset() : success(false), ex(false) {}
  bool success;
  bool ex;
} _Dial_isPrimary_presult__isset;

class Dial_isPrimary_presult {
 public:


  virtual ~Dial_isPrimary_presult() throw() {}

  RetCode::type* success;
  Xception ex;

  _Dial_isPrimary_presult__isset __isset;
...
class DialClient : virtual public DialIf {
 public:
  ...
  RetCode::type isPrimary(const bool isPrimary);
  void send_isPrimary(const bool isPrimary);
  RetCode::type recv_isPrimary();
  RetCode::type addHealthGroup(const HealthGroupInfo& health, const std::string& policyName);
...
class DialProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_isPrimary(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  DialProcessor(boost::shared_ptr<DialIf> iface) :
    ...
    processMap_["isPrimary"] = &DialProcessor::process_isPrimary;
...
class DialMultiface : virtual public DialIf {
 ...
 public:
  ...
  RetCode::type isPrimary(const bool isPrimary) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->isPrimary(isPrimary);
    }
    return ifaces_[i]->isPrimary(isPrimary);
  }
