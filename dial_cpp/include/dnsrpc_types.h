...
extern const std::map<int, const char*> _NetType_VALUES_TO_NAMES;
...
extern const std::map<int, const char*> _HaType_VALUES_TO_NAMES;

struct SysHaPolicy {
  enum type {
    UNKNOWN = 0,
    SYS_POLICY_STOP_OSPF = 1,
    SYS_POLICY_START_XPROXY = 2
  };
};

extern const std::map<int, const char*> _SysHaPolicy_VALUES_TO_NAMES;
...
typedef struct _StaticRoute__isset {
  _StaticRoute__isset() : ip(false), mask(false), nextHop(false) {}
  bool ip;
  bool mask;
  bool nextHop;
} _StaticRoute__isset;
...
class StaticRoute {
 public:
  ...
  static const char* ascii_fingerprint; // = "E1DCF9B7510773BCAE8171C8586BA406";
  static const uint8_t binary_fingerprint[16]; // = {0xE1,0xDC,0xF9,0xB7,0x51,0x07,0x73,0xBC,0xAE,0x81,0x71,0xC8,0x58,0x6B,0xA4,0x06};

  StaticRoute() : mask(0) {
  }

  virtual ~StaticRoute() throw() {}

  IpAddr ip;
  int32_t mask;
  IpAddr nextHop;

  _StaticRoute__isset __isset;
  ...
  void __set_nextHop(const IpAddr& val) {
    nextHop = val;
  }

  bool operator == (const StaticRoute & rhs) const
  {
    if (!(ip == rhs.ip))
      return false;
    if (!(mask == rhs.mask))
  ...
  bool operator < (const StaticRoute & ) const;
...
typedef struct _OspfRoute__isset {
  _OspfRoute__isset() : routeId(false), areaId(false), areaType(false), netName(false) {}
  bool routeId;
  bool areaId;
  bool areaType;
  bool netName;
...
class OspfRoute {
 public:
  ...
  OspfRoute() : routeId(), areaId(), areaType(), netName() {
  }

  virtual ~OspfRoute() throw() {}
  ...
  _OspfRoute__isset __isset;

  void __set_routeId(const std::string& val) {
    routeId = val;
  }

  void __set_areaId(const std::string& val) {
    areaId = val;
  }

  void __set_areaType(const std::string& val) {
    areaType = val;
  }

  void __set_netName(const std::string& val) {
    netName = val;
  }

  bool operator == (const OspfRoute & rhs) const
  {
    if (!(routeId == rhs.routeId))
      return false;
    if (!(areaId == rhs.areaId))
      return false;
    if (!(areaType == rhs.areaType))
      return false;
    if (!(netName == rhs.netName))
      return false;
    return true;
  }
  bool operator != (const OspfRoute &rhs) const {
  ...
  bool operator < (const OspfRoute & ) const;
...
typedef struct _HostHaConf__isset {
  _HostHaConf__isset() : netName(false), typ(false), localIp(false), remoteIp(false), virtualIp(false), password(false), switchSeconds(false) {}
  bool netName;
  bool typ;
  bool localIp;
  bool remoteIp;
...
class HostHaConf {
 public:
  ...
  static const char* ascii_fingerprint; // = "E67A88B1F1E1F2ECF9864C25624CB0DD";
  static const uint8_t binary_fingerprint[16]; // = {0xE6,0x7A,0x88,0xB1,0xF1,0xE1,0xF2,0xEC,0xF9,0x86,0x4C,0x25,0x62,0x4C,0xB0,0xDD};

  HostHaConf() : netName(), typ((HaType::type)0), password(), switchSeconds(0) {
  }

  virtual ~HostHaConf() throw() {}
  ...
  IpAddr virtualIp;
  std::string password;
  int32_t switchSeconds;

  _HostHaConf__isset __isset;

  void __set_netName(const std::string& val) {
    netName = val;
  }

  void __set_typ(const HaType::type val) {
    typ = val;
  }

  void __set_localIp(const IpAddr& val) {
    localIp = val;
  }

  void __set_remoteIp(const IpAddr& val) {
    remoteIp = val;
  }

  void __set_virtualIp(const IpAddr& val) {
    virtualIp = val;
  }
  ...
  void __set_switchSeconds(const int32_t val) {
    switchSeconds = val;
  }

  bool operator == (const HostHaConf & rhs) const
  {
    if (!(netName == rhs.netName))
      return false;
    if (!(typ == rhs.typ))
      return false;
    if (!(localIp == rhs.localIp))
      return false;
    if (!(remoteIp == rhs.remoteIp))
      return false;
    if (!(virtualIp == rhs.virtualIp))
      return false;
    if (!(password == rhs.password))
      return false;
    if (!(switchSeconds == rhs.switchSeconds))
      return false;
    return true;
  }
  bool operator != (const HostHaConf &rhs) const {
  ...
  bool operator < (const HostHaConf & ) const;
...
typedef struct _NotifyServer__isset {
  _NotifyServer__isset() : port(false), protocal(false), ip(false), types(false) {}
  bool port;
  bool protocal;
  bool ip;
  bool types;
} _NotifyServer__isset;

class NotifyServer {
 public:

  static const char* ascii_fingerprint; // = "DFE4E19CF0A133E12FC667D22C403AB0";
  static const uint8_t binary_fingerprint[16]; // = {0xDF,0xE4,0xE1,0x9C,0xF0,0xA1,0x33,0xE1,0x2F,0xC6,0x67,0xD2,0x2C,0x40,0x3A,0xB0};

  NotifyServer() : port(0), protocal() {
  }

  virtual ~NotifyServer() throw() {}

  int32_t port;
  std::string protocal;
  IpAddr ip;
  std::vector<AlarmType::type>  types;

  _NotifyServer__isset __isset;

  void __set_port(const int32_t val) {
    port = val;
  }

  void __set_protocal(const std::string& val) {
    protocal = val;
  }
  ...
  void __set_types(const std::vector<AlarmType::type> & val) {
    types = val;
  }

  bool operator == (const NotifyServer & rhs) const
  {
    if (!(port == rhs.port))
      return false;
    if (!(protocal == rhs.protocal))
      return false;
    if (!(ip == rhs.ip))
      return false;
    if (!(types == rhs.types))
  ...
  bool operator < (const NotifyServer & ) const;
...
typedef struct _HeartBeatState__isset {
  _HeartBeatState__isset() : mState(false) {}
  bool mState;
...
class HeartBeatState {
 public:
  ...
  HeartBeatState() : mState((ModuleState::type)0) {
  }
